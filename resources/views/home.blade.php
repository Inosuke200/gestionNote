  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h5 class="text-light text-center"><a href="{{route('superadmin.home')}}">KABORE Ousmane </a></h5>
        <h6 class="text-center">Professeur Principal 6ème</h6>
          ...
          <li>
              <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown" href="{{route('ajoutprof')}}">Ajouter un élève</a>
                    <a class="dropdown" href="#">Ajouter une note</a>
...
<div class="row justify-content-center mt-5">
  <div class="col-md-8">
      <div class="card">
          <div class="card-header class font-weight-bold">{{ __('Ajouter élève') }}</div>
