  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h5 class="text-light text-center"><a href="index.html">OUIYA Ismaël</a></h5>
        ...
        <ul>
          ...
          <li id="view_details"><a href=""> 
           <div class="dropdown">
              ...
              {{-- <ul class="d-none" id="get_started">
                  <li><a href="{{route('register')}}">Ajouter un professeur</a></li>
                  <li><a href="#">Ajouter un élève</a></li>
                  <li><a href="#">Ajouter un module</a></li> 
              </ul> --}}
           </li> 
          <li><a href="#contact"><i class="bx bx-envelope"></i> Contact</a></li>
          <li>  <a class="dropdown" href="{{ route('logout') }}"
          ...
          <div class="col-md-8">
              <div class="card">
                  <div class="card-header">{{ __('Dashboard') }}</div>
                          <h1>Page d'accueil superadministrateur</h1>
                  <div class="card-body">
                      @if (session('status'))
